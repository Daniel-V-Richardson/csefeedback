...
const CSEForm5B = () => {
  const handleSubmit = (event) => {
    ...
    const ref = collection(firestore, "cse-feedbacks/5/PQT");
    ...
    alert(
      "Your Data has been recorded for PQT. Continue with the next Subject"
    );
  ...
  const handleSubmitCC = (event) => {
    ...
    const ref = collection(firestore, "cse-feedbacks/5/CA/");
    ...
    alert("Your Data has been recorded for CA. Continue with the next Subject");
    alert("Note:- Once Submitted. No need to Submit Again!!");
  };
  const handleSubmitDM = (event) => {
    event.preventDefault();

    const ref = collection(firestore, "cse-feedbacks/5/DBMS/");
    ...
    alert("Your Data has been recorded for DBMS. Continue with the next Subject");
    alert("Note:- Once Submitted. No need to Submit Again!!");
  };
  const handleSubmitPOM = (event) => {
    event.preventDefault();

    const ref = collection(firestore, "cse-feedbacks/5/DAA/");
    ...
    alert(
      "Your Data has been recorded for DAA. Continue with the next Subject"
    );
    alert("Note:- Once Submitted. No need to Submit Again!!");
  };
  const handleSubmitET = (event) => {
    ...
    const ref = collection(firestore, "cse-feedbacks/5/OS/");
    ...
    alert("Your Data has been recorded for OS. Continue with the next Subject");
    alert("Note:- Once Submitted. No need to Submit Again!!");
  };
  const handleSubmitSE = (event) => {
    event.preventDefault();

    const ref = collection(firestore, "cse-feedbacks/5/SE/");
    ...
    alert("Your Data has been recorded for SE. Continue with the next Subject");
    alert("Note:- Once Submitted. No need to Submit Again!!");
  };
  const handleSubmitCC_LAB = (event) => {
    event.preventDefault();

    const ref = collection(firestore, "cse-feedbacks/5/DBMS_LAB/");
    ...
    alert(
      "Your Data has been recorded for DBMS Lab. Continue with the next Subject"
    );
    alert("Note:- Once Submitted. No need to Submit Again!!");
  };
  const handleSubmitNS_LAB = (event) => {
    ...
    const ref = collection(firestore, "cse-feedbacks/5/OS_LAB/");
    ...
    alert(
      "Your Data has been recorded for OS Lab. Thank You for Giving your feedback"
    );
    alert(
      "You have successfully completed your Freedback form. You may Exit Now!!"
    );
  };
  ...
  return (
    <div className="form-container">
      ...
      <form className="form" onSubmit={handleSubmit}>
        <Accordion>
          <AccordionSummary
            ...
            id="panel1a-header"
          >
            <Typography>Probability and Queueing Theory</Typography>
          </AccordionSummary>
          <AccordionDetails>
            <div className="item">
      ...
      <form className="form" onSubmit={handleSubmitDM}>
        <Accordion>
          <AccordionSummary
            ...
            id="panel1a-header"
          >
            <Typography>Database Management System</Typography>
          </AccordionSummary>
          <AccordionDetails>
            <div className="item">
              <label htmlFor="name">Enter your name </label>
      ...
      <form className="form" onSubmit={handleSubmitPOM}>
        <Accordion>
          <AccordionSummary
            ...
            id="panel1a-header"
          >
            <Typography>Design and Analysis of Algorithms</Typography>
          </AccordionSummary>
          <AccordionDetails>
            <div className="item">
              <label htmlFor="name">Enter your name </label>
      ...
      {/* Form for SE */}
      <form className="form" onSubmit={handleSubmitSE}>
        <Accordion>
          <AccordionSummary
            expandIcon={<ExpandMoreIcon />}
            aria-controls="panel1a-content"
      ...
      <form className="form" onSubmit={handleSubmitCC_LAB}>
        <Accordion>
          <AccordionSummary
            ...
            id="panel1a-header"
          >
            <Typography>Database Management Systems Laboratory</Typography>
          </AccordionSummary>
          <AccordionDetails>
            <div className="item">
              <label htmlFor="name">Enter your name </label>
      ...
      <form className="form" onSubmit={handleSubmitNS_LAB}>
        <Accordion>
          <AccordionSummary
            ...
            id="panel1a-header"
          >
            <Typography>Operating Systems Laboratory</Typography>
          </AccordionSummary>
          <AccordionDetails>
            <div className="item">
              <label htmlFor="name">Enter your name </label>
